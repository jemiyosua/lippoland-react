...
const ModalUpdateCompanyOverview = ({ showModal, onChangeImage, fileInputRef, previewUrl, onClickClearImage, titleUpdate, setTitleUpdate, alertTitle, setAlertTitle, descriptionUpdate, setDescriptionUpdate, alertDescription, setAlertDescription, onClickCancel, onClickUpdate, imagePreview }) => {
    return (
        <Modal
            show={showModal}
            size="lg"
        ...
        >
            <Modal.Body>
                ...
                <h3 style={{ color:'#004372', fontWeight:'bold' }}>UPDATE COMPANY OVERVIEW</h3>
...
export default ModalUpdateCompanyOverview
