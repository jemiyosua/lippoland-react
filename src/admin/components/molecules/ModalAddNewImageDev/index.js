...
const ModalAddNewImageDev = ({ showModal, onChangeImage, fileInputRef, previewUrl, onClickClearImage, alertImage, setAlertImage, titleAddNew, setTitleAddNew, alertTitle, setAlertTitle, descriptionAddNew, setDescriptionAddNew, alertDescription, setAlertDescription, onClickCancel, onClickAddNew }) => {
    return (
        <Modal
            show={showModal}
            size="lg"
        ...
        >
            <Modal.Body>
                ...
                <h3 style={{ color:'#004372', fontWeight:'bold' }}>ADD NEW IMAGE DEVELOPMENT</h3>
                ...
                <Row>
                    <Col xs={3} md={4} lg={4} style={{ paddingRight:6 }} >
                        ...
                        {alertImage && <div style={{ fontSize:12, color:'red', fontWeight:'bold' }}>Image cannot null</div>}
                    </Col>
                </Row>
...
export default ModalAddNewImageDev
