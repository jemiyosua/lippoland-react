...
const ModalUpdateCategoryDev = ({ showModal, categoryNameUpdate, setCategoryNameUpdate, alertCategoryName, setAlertCategoryName, onClickCancel, onClickUpdate }) => {
    return (
        <Modal
            show={showModal}
            size="lg"
        ...
        >
            <Modal.Body>
                ...
                <h3 style={{ color:'#004372', fontWeight:'bold' }}>UPDATE CATEGORY DEVELOPMENT</h3>
                    ...
                    <Col xs={12} md={12} lg={12} style={{ paddingRight:6 }} >
                        ...
                        <div style={{ marginBottom:5 }}>
                            <Input
                                ...
                                onChange={setCategoryNameUpdate}
...
export default ModalUpdateCategoryDev
