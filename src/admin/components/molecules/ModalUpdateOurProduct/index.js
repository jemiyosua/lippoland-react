...
const ModalUpdateOurProduct = ({ showModal, onChangeImage, fileInputRef, previewUrl, onClickClearImage, alertImage, setAlertImage, titleUpdate, setTitleUpdate, alertTitle, setAlertTitle, onClickCancel, onClickUpdate, heroImagePreview }) => {
    return (
        <Modal
            show={showModal}
            size="lg"
        ...
        >
            <Modal.Body>
                ...
                <h3 style={{ color:'#004372', fontWeight:'bold' }}>UPDATE OUR PRODUCT</h3>
...
export default ModalUpdateOurProduct
