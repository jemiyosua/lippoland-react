...
const ModalAddNewOurProduct = ({ showModal, onChangeImage, fileInputRef, previewUrl, onClickClearImage, TitleAddNew, setTitleAddNew, alertTitle, setAlertTitle, onClickCancel, onClickAddNew }) => {
    return (
        <Modal
            show={showModal}
            size="lg"
        ...
        >
            <Modal.Body>
                ...
                <h3 style={{ color:'#004372', fontWeight:'bold' }}>ADD NEW OUR PRODUCT</h3>
                ...
                <Row>
                    <Col xs={3} md={4} lg={4} style={{ paddingRight:6 }} >
                        <div style={{ fontSize:16, fontWeight:'bold', marginBottom:10, color:'#004372' }}>Image</div>
                        <div>
                            <Input
                                type="file"
...
export default ModalAddNewOurProduct
