...
const ModalAddNewHero = ({ showModal, onChangeImage, fileInputRef, previewUrl, onClickClearImage, heroTitleAddNew, setHeroTitleAddNew, alertHeroTitle, setAlertHeroTitle, heroDescriptionAddNew, setHeroDescriptionAddNew, alertHeroDescription, setAlertHeroDescription, onClickCancel, onClickAddNew }) => {
    return (
        <Modal
            show={showModal}
            size="lg"
        ...
        >
            <Modal.Body>
                ...
                <h3 style={{ color:'#004372', fontWeight:'bold' }}>ADD NEW HERO</h3>
                ...
                <Row>
                    <Col xs={3} md={4} lg={4} style={{ paddingRight:6 }} >
                        ...
                        <div style={{ marginBottom:5 }}>
                            <Input
                                required
                                value={heroTitleAddNew}
                                onChange={setHeroTitleAddNew}
                    ...
                    <Col xs={3} md={4} lg={4} style={{ paddingRight:6 }} >
                        ...
                        <div style={{ marginBottom:5 }}>
                            <Input
                                required
                                value={heroDescriptionAddNew}
                                onChange={setHeroDescriptionAddNew}
