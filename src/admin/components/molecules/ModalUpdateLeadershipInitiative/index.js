...
const ModalUpdateLeadershipInitiative = ({ showModal, titleUpdate, setTitleUpdate, alertTitle, setAlertTitle, descriptionUpdate, setDescriptionUpdate, alertDescription, setAlertDescription, onClickCancel, onClickUpdate }) => {
    return (
        <Modal
            show={showModal}
            size="lg"
...
export default ModalUpdateLeadershipInitiative