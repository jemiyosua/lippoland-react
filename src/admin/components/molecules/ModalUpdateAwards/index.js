...
const ModalUpdateAwards = ({ showModal, onChangeImage, fileInputRef, previewUrl, onClickClearImage, titleUpdate, setTitleUpdate, alertTitle, setAlertTitle, descriptionUpdate, setDescriptionUpdate, alertDescription, setAlertDescription, yearUpdate, setYearUpdate, alertYear, setAlertYear, onClickCancel, onClickUpdate, imagePreview }) => {
    return (
        <Modal
            show={showModal}
            size="lg"
        ...
        >
            <Modal.Body>
                ...
                <h3 style={{ color:'#004372', fontWeight:'bold' }}>UPDATE AWARDS</h3>
...
export default ModalUpdateAwards
