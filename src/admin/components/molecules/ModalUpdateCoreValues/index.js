...
const ModalUpdateVisionMision = ({ showModal, titleUpdate, setTitleUpdate, alertTitle, setAlertTitle, titleDescUpdate, setTitleDescUpdate, alertTitleDesc, setAlertTitleDesc, descriptionUpdate, setDescriptionUpdate, alertDescription, setAlertDescription, onClickCancel, onClickUpdate }) => {
    return (
        <Modal
            show={showModal}
            size="lg"
        ...
        >
            <Modal.Body>
                ...
                <h3 style={{ color:'#004372', fontWeight:'bold' }}>UPDATE CORE VALUES</h3>
                ...
                <Row>
                    ...
                    <Col xs={3} md={4} lg={4} style={{ paddingRight:6 }} >
                        <div style={{ fontSize:16, fontWeight:'bold', marginBottom:10, color:'#004372' }}>Title Description</div>
                        <div style={{ marginBottom:5 }}>
                            <Input
                                required
                                value={titleDescUpdate}
                                onChange={setTitleDescUpdate}
                                onFocus={setAlertTitleDesc}
                            />
                        </div>
                        {alertTitleDesc && <div style={{ fontSize:12, color:'red', fontWeight:'bold' }}>Title Desc cannot null</div>}
                    </Col>
                </Row>
