...
import { Input, Dropdown, Alert, PopupImagePreview, ModalAddNewAwards, ModalUpdateAwards } from '../../../components';
...
const ListAwards = () => {
	...
	const [ListAwardsYear, setListAwardsYear] = useState([])
    ...
    const [YearAddNew, setYearAddNew] = useState("")
    // ---------- end of add new -----------
	...
	useEffect(() => {
        ...
        if (CookieParamKey == null || CookieParamKey === "" || CookieUsername == null || CookieUsername === "") {
            ...
            dispatch(setForm("SubPageActive","AWARDS"))
    ...
    // { ---------- start curl ----------
    const getListAwards = (page, position, searchValue, searchType, id) => {
		...
		var url = paths.URL_API_ADMIN + 'Awards';
    ...
    const getListYear = () => {
		...
		var url = paths.URL_API_ADMIN + 'AwardsYear';
		var Signature  = generateSignature(requestBody)
    ...
    const handleChangeStatus = (id, status) => {
        ...
        vListAwards.map((item,index) => {
            if (item.Id === id) {
                vListAwards[index].Status = vStatus
                handleUpdate(vStatus, "status", id)
            }
        })
        setListAwards(vListAwards)
    }
                        ...
                        <div>
                            ...
                            <Table striped bordered hover responsive cellspacing="0" cellpadding="10" style={{ fontSize:13, borderColor:'white', width:'100%' }}>
                                    ...
                                    <Tr style={{color:"#004372", borderColor:'white', textAlign:'left'}}>
                                        <Th className="tabelHeader">
                                            <Dropdown onChange={event => {
                                                getListAwards(1, "", event.target.value, "status", "")
                                            }}>
                                        ...
                                        <Th className="tabelHeader">
                                            <Input
                                                ...
                                                onKeyDown={event => {
                                                    if (event.key === 'Enter') {
                                                        getListAwards(1, "", event.target.value, "title", "")
                                                        event.target.blur()
                                                    }
                                                }}
                                                placeHolder={'Title'}
                                        ...
                                        <Th className="tabelHeader">
                                            <Input
                                                ...
                                                onKeyDown={event => {
                                                    if (event.key === 'Enter') {
                                                        getListAwards(1, "", event.target.value, "desc", "")
                                                        event.target.blur()
                                                    }
                                                }}
                                        ...
                                        <Th className="tabelHeader">
                                            <Dropdown onChange={event => {
                                                getListAwards(1, "", event.target.value, "year", "")
                                            }}>
                                                <option value="">Year</option>
                                                {ListAwardsYear.map((item,index) => {
                                ...
                                <Tbody>
                                    ...
                                    :
                                    ListAwards.length > 0 ? ListAwards.map((item,index)=>{
                                    return <Tr style={{
                                        marginBottom:20,
                                        borderBottomWidth:1,
                                        ...
                                        borderRightWidth:1,
                                            ...
                                            <td style={{ paddingTop:20, paddingBottom:20, textAlign:'center' }}>
                                                <img src={item.Images} style={{ maxWidth:200, maxHeight:200 }} onClick={() => handleTogglePopup(item.Images)} className="clickable-image" />
                                            </td>
                                            ...
                                            <td style={{ paddingTop:20, paddingBottom:20 }}>{item.Year}</td>
                                            ...
                                            <td>
                                                <img 
                                                    ...
                                                    onClick={() => {
                                                        ...
                                                        getListAwards(1, "detail", "", "", item.Id)
                                                    }}
                                                />
                                            </td>
                                            <td>
                            ...
                            <ModalAddNewAwards
                                ...
                                yearAddNew={YearAddNew}
                                setYearAddNew={event => setYearAddNew(event.target.value)}
                                alertYear={AlertYear}
                                setAlertYear={() => setAlertYear(false)}
                            ...
                            <ModalUpdateAwards
                                ...
                                setYearUpdate={event => setYearUpdate(event.target.value)}
                                alertYear={AlertYear}
                                setAlertYear={() => setAlertYear(false)}
