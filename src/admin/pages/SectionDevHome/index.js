...
import DevCategoryList from './DevCategoryList';
import DevImageList from './DevImageList';
import "./Tab.css"

const SectionDevHome = () => {
        ...
        <div>
            ...
            <div>
                <button role="tab" aria-controls="merchant-list">
                    <div style={{ color:'#004372', fontSize:16, fontWeight:'bold' }}>IMAGE DEV LIST</div>
                </button>
            </div>
