...
import { Input, Dropdown, Alert, ModalAddNewHero, ModalUpdateHero, PopupImagePreview } from '../../../components';
...
const ListHero = () => {
    ...
    // { ---------- start curl ----------
    const getListHeroHome = (page, position, searchValue, searchType, id) => {
        ...
        if (position === "reset-filter") {
            ...
            if (searchType !== "") {
                if (searchType === "hero_title") {
                    SearchTitle = searchValue
                } else if (searchType === "hero_desc") {
                    SearchDesc = searchValue
                } else if (searchType === "hero_status") {
		...
		var url = paths.URL_API_ADMIN + 'HeroHome';
    ...
    const handleChangeStatus = (id, status) => {
        var vListHeroHome = ListHeroHome
        ...
        vListHeroHome.map((item,index) => {
            if (item.Id === id) {
                vListHeroHome[index].Status = vStatus
                handleUpdate(vStatus, "status", id)
            }
        })
        setListHeroHome(vListHeroHome)
    }
                        ...
                        <div>
                            ...
                            <Table striped bordered hover responsive cellspacing="0" cellpadding="10" style={{ fontSize:13, borderColor:'white', width:'100%' }}>
                                    ...
                                    <Tr style={{color:"#004372", borderColor:'white', textAlign:'left'}}>
                                        <Th className="tabelHeader">
                                            <Dropdown onChange={event => {
                                                getListHeroHome(1, "", event.target.value, "hero_status", "")
                                            }}>
                                        ...
                                        <Th className="tabelHeader">
                                            <Input
                                                ...
                                                onKeyDown={event => {
                                                    if (event.key === 'Enter') {
                                                        getListHeroHome(1, "", event.target.value, "hero_title", "")
                                                        event.target.blur()
                                                    }
                                                }}
                                                placeHolder={'Title'}
                                        ...
                                        <Th className="tabelHeader">
                                            <Input
                                                ...
                                                onKeyDown={event => {
                                                    if (event.key === 'Enter') {
                                                        getListHeroHome(1, "", event.target.value, "hero_desc", "")
                                                        event.target.blur()
                                                    }
                                                }}
                                        ...
                                        <Th className="tabelHeader">Order Hero</Th>
                                ...
                                <Tbody>
                                    ...
                                    :
                                    ListHeroHome.length > 0 ? ListHeroHome.map((item,index)=>{
                                    return <Tr style={{
                                        marginBottom:20,
                                        borderBottomWidth:1,
                                        ...
                                        borderRightWidth:1,
                                            ...
                                            <td style={{ color:'#004175', fontWeight:'bold', textAlign:'center', paddingTop:20, paddingBottom:20 }}>{item.OrderHero}</td>
                                            ...
                                            <td>
                                                <img 
                                                    ...
                                                    onClick={() => {
                                                        ...
                                                        getListHeroHome(1, "detail", "", "", item.Id)
                                                    }}
                                                />
                                            </td>
                                            <td>
                            ...
                            <ModalAddNewHero
                                ...
                                heroTitleAddNew={TitleAddNew}
                                setHeroTitleAddNew={event => setTitleAddNew(event.target.value)}
                                alertHeroTitle={AlertTitle}
                                setAlertHeroTitle={() => setAlertTitle(false)}
                                heroDescriptionAddNew={DescriptionAddNew}
                                setHeroDescriptionAddNew={event => setDescriptionAddNew(event.target.value)}
                                alertHeroDescription={AlertDescription}
                                setAlertHeroDescription={() => setAlertDescription(false)}
                            ...
                            <ModalUpdateHero
                                ...
                                previewUrl={PreviewUrl}
                                onClickClearImage={() => handleClearImage()}
                                heroTitleUpdate={TitleUpdate}
                                setHeroTitleUpdate={event => setTitleUpdate(event.target.value)}
                                alertHeroTitle={AlertTitle}
                                setAlertHeroTitle={() => setAlertTitle(false)}
                                heroDescriptionUpdate={DescriptionUpdate}
                                setHeroDescriptionUpdate={event => setDescriptionUpdate(event.target.value)}
                                alertHeroDescription={AlertDescription}
                                setAlertHeroDescription={() => setAlertDescription(false)}
