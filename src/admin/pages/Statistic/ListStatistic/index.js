...
import { Alert, ModalUpdateStatistic, PopupImagePreview } from '../../../components';
...
const ListStatistic = () => {
	...
	useEffect(() => {
        ...
        if (CookieParamKey == null || CookieParamKey === "" || CookieUsername == null || CookieUsername === "") {
            ...
            dispatch(setForm("SubPageActive","STATISTIC"))
    ...
    // { ---------- start curl ----------
    const getListStatistic = (page, position, searchValue, searchType, id) => {
		...
		var url = paths.URL_API_ADMIN + 'Statistic';
    ...
    const handleChangeStatus = (id, status) => {
        var vListStatistic = ListStatistic
        ...
        vListStatistic.map((item,index) => {
            if (item.Id === id) {
                vListStatistic[index].Status = vStatus
                handleUpdate(vStatus, "status")
            }
        })
        setListStatistic(vListStatistic)
    }
                        ...
                        <div>
                            ...
                            <Table striped bordered hover responsive cellspacing="0" cellpadding="10" style={{ fontSize:13, borderColor:'white', width:'100%' }}>
                                ...
                                <Tbody>
                                    ...
                                    :
                                    ListStatistic.length > 0 ? ListStatistic.map((item,index)=>{
                                    return <Tr style={{
                                        marginBottom:20,
                                        borderBottomWidth:1,
                                            ...
                                            <td>
                                                <img
                                                    ...
                                                    onClick={() => {
                                                        ...
                                                        getListStatistic(1, "detail", "", "", item.Id)
                                                    }}
                                                />
                                            </td>
                                        </Tr>
