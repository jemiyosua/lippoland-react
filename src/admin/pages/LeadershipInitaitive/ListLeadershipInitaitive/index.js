...
import { Alert, ModalUpdateLeadershipInitiative } from '../../../components';
...
import { IconRefresh, IconUpdateProduct } from '../../../assets';

const ListLeadershipInitaitive = () => {
	...
	const [ListLeadershipInitaitive, setListLeadershipInitaitive] = useState([])
	...
	useEffect(() => {
        ...
        if (CookieParamKey == null || CookieParamKey === "" || CookieUsername == null || CookieUsername === "") {
            ...
            dispatch(setForm("SubPageActive","LEADERSHIP-INITIATIVE"))

            getListLeadershipInitiative(1, "", "", "")
        }
    ...
    // { ---------- start curl ----------
    const getListLeadershipInitiative = (page, position, searchValue, searchType, id) => {
		...
		var url = paths.URL_API_ADMIN + 'LeadershipInitiative';
		...
		.then((data) => {
			...
			if (data.ErrorCode === "0") {
                if (position == "detail") {
                    ...
                    setListLeadershipInitaitive(data.Result)
    ...
    const handleChangeStatus = (id, status) => {
        var vListLeadershipInitaitive = ListLeadershipInitaitive
        ...
        vListLeadershipInitaitive.map((item,index) => {
            if (item.Id === id) {
                vListLeadershipInitaitive[index].Status = vStatus
                handleUpdate(vStatus, "status")
            }
        })
        setListLeadershipInitaitive(vListLeadershipInitaitive)
    }

    const handlePageClick = (data) => {
        let currentPage = data.selected + 1
        setPaging(data.selected)
        setListLeadershipInitaitive([])
        getListLeadershipInitiative(currentPage, "", "", "", "")
    }
                        ...
                        <div>
                            ...
                            <Table striped bordered hover responsive cellspacing="0" cellpadding="10" style={{ fontSize:13, borderColor:'white', width:'100%' }}>
                                ...
                                <Tbody>
                                    ...
                                    :
                                    ListLeadershipInitaitive.length > 0 ? ListLeadershipInitaitive.map((item,index)=>{
                                    return <Tr style={{
                                        marginBottom:20,
                                        borderBottomWidth:1,
                                            ...
                                            <td>
                                                <img
                                                    ...
                                                    onClick={() => {
                                                        ...
                                                        getListLeadershipInitiative(1, "detail", "", "", item.Id)
                                                    }}
                                                />
                                            </td>
                                        </Tr>
                            ...
                            <ModalUpdateLeadershipInitiative
...
export default ListLeadershipInitaitive