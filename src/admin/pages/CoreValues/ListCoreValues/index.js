...
import { Alert, ModalUpdateCoreValues, ModalUpdateVisionMision } from '../../../components';
...
const ListCoreValues = () => {
    ...
    const [TitleDescUpdate, setTitleDescUpdate] = useState("")
    ...
    const [AlertTitleDesc, setAlertTitleDesc] = useState(false)
    ...
    // { ---------- start curl ----------
    const getListCoreValues = (page, position, searchValue, searchType, id) => {
		...
		var url = paths.URL_API_ADMIN + 'CoreValues';
		...
		.then((data) => {
			...
			if (data.ErrorCode === "0") {
                if (position == "detail") {
                    ...
                    setTitleDescUpdate(data.Result[0].TitleDesc)
    ...
    const handleUpdate = (status, paramUpdate) => {
        ...
        if (paramUpdate == "status") {
            ...
            if (TitleDescUpdate == "") {
                errorMessage += "\n Title Description can't null value"
            }
    ...
    const handleChangeStatus = (id, status) => {
        var vListCoreValues = ListCoreValues
        ...
        vListCoreValues.map((item,index) => {
            if (item.Id === id) {
                vListCoreValues[index].Status = vStatus
                handleUpdate(vStatus, "status")
            }
        })
        setListCoreValues(vListCoreValues)
    }
                ...
                <div className="blog-post">
                    ...
                    <div style={{ backgroundColor:'#FFFFFF', width:'100%', borderBottomLeftRadius:25, borderBottomRightRadius:25, borderTopRightRadius:25, padding:20 }}>
                        <div>
                            ...
                            <Table striped bordered hover responsive cellspacing="0" cellpadding="10" style={{ fontSize:13, borderColor:'white', width:'100%' }}>
                                <Thead>
                                    <Tr style={{color:"#004372", borderColor:'white', textAlign:'left'}}>
                                        ...
                                        <Th className="tabelHeader">Title Description</Th>
                                ...
                                <Tbody>
                                    ...
                                    :
                                    ListCoreValues.length > 0 ? ListCoreValues.map((item,index)=>{
                                    return <Tr style={{
                                        marginBottom:20,
                                        borderBottomWidth:1,
                                        ...
                                        borderRightWidth:1,
                                            ...
                                            <td style={{ color:'#004175', fontWeight:'bold', paddingTop:20, paddingBottom:20, fontSize:15 }}>{item.Title}</td>
                                            <td style={{ paddingTop:20, paddingBottom:20 }}>{item.TitleDesc}</td>
                                            ...
                                            <td>
                                                <img
                                                    ...
                                                    onClick={() => {
                                                        ...
                                                        getListCoreValues(1, "detail", "", "", item.Id)
                                                    }}
                                                />
                                            </td>
                                        </Tr>
                            ...
                            <ModalUpdateCoreValues
                                showModal={ShowModalUpdate}
                                titleUpdate={TitleUpdate}
                                setTitleUpdate={event => setTitleUpdate(event.target.value)}
                                alertTitle={AlertTitle}
                                setAlertTitle={() => setAlertTitle(false)}
                                titleDescUpdate={TitleDescUpdate}
                                setTitleDescUpdate={event => setTitleDescUpdate(event.target.value)}
                                alertTitleDesc={AlertTitleDesc}
                                setAlertTitleDesc={() => setAlertTitleDesc(false)}
